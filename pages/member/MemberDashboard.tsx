        ...
        <section className="space-y-8">
          <div className="flex items-center justify-between border-b border-stone-100 pb-4">
            ...
            <div className="flex gap-4">
               <button className="text-[10px] font-bold text-[#FF8C6B] bg-[#FFF5F0] px-3 py-1 rounded-full">ALL COURSES</button>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {courses.map((course) => (
              <MemberCourseCard 
                key={course.id} 
                course={course} 
                // Bloqueia apenas o Professional para o Demo
                isLocked={course.id === 'professional'} 
